        ...
        <div className="pt-8 border-t border-white/10-- border-black/10">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            ...
            <div className="flex gap-4">
              <a href="https://www.instagram.com/yaana_group_?igsh=MXcxdjN1cnV5ZWJydQ==" className="w-8 h-8 rounded-full bg-white/10 hover:bg-lavender-600 flex items-center justify-center transition-colors" aria-label="Instagram">
              ...
              {/* <a href="#" className="w-8 h-8 rounded-full bg-white/10-- hover:bg-lavender-600 flex items-center justify-center transition-colors" aria-label="Twitter">
              ...
              <a href="https://www.facebook.com/profile.php?id=61591324634349" className="w-8 h-8 rounded-full bg-white/10-- hover:bg-lavender-600 flex items-center justify-center transition-colors" aria-label="Facebook">
